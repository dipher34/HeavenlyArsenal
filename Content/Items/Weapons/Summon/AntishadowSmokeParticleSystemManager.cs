...
public class AntishadowSmokeParticleSystemManager : ModSystem
{
    /// <summary>
    ...
    private static void PrepareShader()
    {
        ...
        overlayShader.TrySetParameter("turbulence", 0.03f);
        ...
        overlayShader.TrySetParameter("initialGlowIntensity", 01f);
        overlayShader.TrySetParameter("initialGlowDuration", 0.6f);
    ...
    {
        float ShrinkRate = 0.02f;
        particle.Size.X *= 0.4f - ShrinkRate * 0.85f;
        particle.Size.Y *= 0.4f - ShrinkRate;
